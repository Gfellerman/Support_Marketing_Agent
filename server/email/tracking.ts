 ...
 */
router.get('/open/:campaignId/:contactId/:token', async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/click/:campaignId/:contactId/:token', async (req: Request, res: Response) => {
  try {
    const { campaignId, contactId, token } = req.params;
 ...
 */
function send1x1Pixel(res: Response) {
