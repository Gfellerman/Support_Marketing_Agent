...
export interface WorkflowTemplate {
  ...
  name: string;
  description: string;
  category: 'ecommerce' | 'saas' | 'retail' | 'services' | 'general';
  tags: string[];
  icon: string;
  triggerType: 'welcome' | 'abandoned_cart' | 'order_confirmation' | 'shipping' | 'custom';
  steps: Array<{
    id: string;
 ...
 */
export function getAllCategories(): WorkflowTemplate['category'][] {
