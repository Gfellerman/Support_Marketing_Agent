...
import type { OrderContext } from "./response";
 ...
 */
export function hydrateTemplate(template: string, order?: OrderContext, customerName?: string): string {
  let result = template;
...
const DELAYED_PROFESSIONAL: OrderResponseTemplate = {
  issueType: 'delayed',
...
const DELAYED_EMPATHETIC: OrderResponseTemplate = {
  issueType: 'delayed',
...
const DAMAGED_PROFESSIONAL: OrderResponseTemplate = {
  issueType: 'damaged',
...
const DAMAGED_EMPATHETIC: OrderResponseTemplate = {
  issueType: 'damaged',
...
const WRONG_ITEM_PROFESSIONAL: OrderResponseTemplate = {
...
const REFUND_PROFESSIONAL: OrderResponseTemplate = {
...
const REFUND_EMPATHETIC: OrderResponseTemplate = {
  issueType: 'refund_request',
...
const TRACKING_FRIENDLY: OrderResponseTemplate = {
  issueType: 'tracking',
...
const RETURN_PROFESSIONAL: OrderResponseTemplate = {
...
const CANCELLATION_PROFESSIONAL: OrderResponseTemplate = {
...
export const ORDER_RESPONSE_TEMPLATES: Record<OrderIssueType, OrderResponseTemplate[]> = {
 ...
 */
export function getTemplatesForIssue(issueType: OrderIssueType): OrderResponseTemplate[] {
 ...
 */
export function getTemplateByTone(
  issueType: OrderIssueType, 
  tone: 'professional' | 'friendly' | 'empathetic'
): OrderResponseTemplate | undefined {
 ...
 */
export function getQuickActionsForIssue(issueType: OrderIssueType): string[] {
  const templates = ORDER_RESPONSE_TEMPLATES[issueType];
