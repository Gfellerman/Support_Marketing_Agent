...
export interface TicketClassification {
  category: "order_status" | "shipping" | "returns" | "product_inquiry" | "technical_support" | "billing" | "general";
...
Consider emotional language for sentiment analysis.`;
    ...
    const classification = JSON.parse(content) as TicketClassification;
