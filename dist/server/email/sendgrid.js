 ...
 */
export function generateTrackingPixel(campaignId, contactId) {
    const token = crypto
        .createHash('sha256')
 ...
 */
export function generateTrackingUrl(originalUrl, campaignId, contactId) {
    const token = crypto
        .createHash('sha256')
 ...
 */
export function injectClickTracking(html, campaignId, contactId) {
 ...
 */
export function injectOpenTracking(html, campaignId, contactId) {
 ...
 */
export async function verifySendGridConfig() {
    try {
        if (!SENDGRID_API_KEY) {
            return {
                valid: false,
